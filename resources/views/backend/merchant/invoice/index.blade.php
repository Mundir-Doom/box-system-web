                                ...
                                @foreach ($invoices as $invoice)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('merchant.invoice.pdf',[$merchant_id,$invoice->invoice_id]) }}" class="btn btn-sm btn-info mt-1" target="_blank"><i class="fa fa-file-pdf-o"></i> PDF</a>
                                        </td>
                                    </tr>
                                @endforeach
                                @if($invoices->count() == 0)
                                    <tr>
                                        <td colspan="8" class="text-center py-5">
                                            <div class="text-muted">
                                                ...
                                                <p>This merchant has no invoices yet. Invoices are generated automatically when parcels are delivered or returned.</p>
                                                <p class="small text-muted">
                                                    To generate an invoice, parcels must be:
                                                    <br>• Delivered (status: DELIVERED) or partially delivered
                                                    <br>• Returned (various return statuses)
                                                    <br>• Not already invoiced
                                                </p>
                                                <a href="{{ route('merchant.invoice.generate', $merchant_id) }}" class="btn btn-primary">
