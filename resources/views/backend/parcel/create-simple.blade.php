                            ...
                            <div class="form-section">
                                ...
                                <div class="form-grid">
                                    ...
                                    <div class="form-field">
                                        ...
                                        <select id="shopID" class="modern-select" name="shop_id" data-url="{{ route('parcel.merchant.shops') }}" disabled>
                                            <option value="">{{ __('menus.select') }} {{ __('parcel.shop') }}</option>
                                        </select>
                                        <small class="text-muted" id="shop-help-text">Please select a merchant first to choose their shops</small>
                                        
                                        <!-- Create Shop Button Container (hidden by default) -->
                                        <div id="create-shop-button-container" style="display: none; margin-top: 10px;">
                                            <button type="button" id="create-shop-btn" class="btn btn-outline-success btn-sm">
                                ...
                                <div class="form-grid">
                                    ...
                                    <div class="form-field">
                                        ...
                                        <div class="invoice-input-container">
                                            <input id="invoice_no" type="text" name="invoice_no" class="modern-input invoice-input" 
                                                   placeholder="{{ __('parcel.enter_invoice_number') }}" 
                                                   value="{{ old('invoice_no') }}" readonly>
                                            <button type="button" class="generate-invoice-btn" id="generateInvoiceBtn" title="Generate New Invoice Number">
...
@push('styles')
    ...
    <style>
        ...
        .modern-select:disabled + .select2-container {
            opacity: 0.6;
        }

        .modern-select:disabled + .select2-container .select2-selection {
            background-color: #f8f9fa;
            color: #6c757d;
            cursor: not-allowed;
        }
        ...
        .generate-invoice-btn.loading {
            background: #6c757d;
            cursor: not-allowed;
        }

        .generate-invoice-btn.loading i {
...
@push('scripts')
    ...
    <script>
        ...
        var generateInvoiceUrl = '{{ route('parcel.generate-invoice-number') }}';
...
<!-- Create Shop Modal -->
<div id="createShopModal" class="custom-modal" style="display: none;">
    <div class="custom-modal-content">
        <div class="custom-modal-header">
            <h3>Create New Shop</h3>
            <button type="button" id="closeCreateShopModal" class="custom-close">&times;</button>
        </div>
        <div class="custom-modal-body">
            <form id="createShopForm">
                <input type="hidden" id="selectedMerchantId" value="">
                ...
                <div class="form-group">
                    <label for="shopPhone">Contact Phone *</label>
                    <input type="text" id="shopPhone" class="form-control" required>
                </div>
                
                <div class="form-group">
                    <label for="shopAddress">Address *</label>
                    <textarea id="shopAddress" class="form-control" rows="3" required></textarea>
                </div>
                
                <div class="form-check">
                    <input type="checkbox" id="setAsDefault" class="form-check-input">
                    <label for="setAsDefault" class="form-check-label">Set as default shop</label>
                </div>
            </form>
        </div>
        <div class="custom-modal-footer">
            <button type="button" id="cancelCreateShopModal" class="btn btn-secondary">Cancel</button>
            <button type="button" id="submitCreateShop" class="btn btn-success">Create Shop</button>
        </div>
    </div>
</div>
