                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item ">
                            @if (hasPermission('dashboard_read') == true)
                                <a class="nav-link {{ request()->is('/dashboard*') ? 'active' : '' }}"
                                    href="{{ url('/dashboard') }}" aria-expanded="false" data-bs-target="#submenu-1"
                        ...
                        @if (hasPermission('delivery_man_read') == true)
                            <li class="nav-item ">
                                <a class="nav-link {{ request()->is('admin/deliveryman*') ? 'active' : '' }}"
                                    ...
                                    data-bs-target="#submenu-1" aria-controls="submenu-1"><i
                                        class="fa fa-people-carry"></i>{{ __('menus.deliveryman') }}</a>
                            </li>
                        @endif
                        @if (hasPermission('hub_read') == true || hasPermission('hub_payment_read') == true || hasPermission('hub_pricing_read') == true)
                            <li class="nav-item">
                                <a class="nav-link {{ request()->is('admin/hubs*', 'admin/request/hub/payment*', 'admin/hub/incharge*', 'admin/hub/view*', 'admin/hub-pricing*', 'admin/hub-payment*') ? 'active' : '' }}"
                                    href="#" data-bs-toggle="collapse" aria-expanded="false"
                                    data-bs-target="#hub-manage" aria-controls="hub-manage"><i
                                        class="fas fa-warehouse"></i>{{ __('menus.hub_mange') }}</a>
                                <div id="hub-manage"
                                    class="{{ request()->is('admin/hubs*', 'admin/request/hub/payment*', 'admin/hub/incharge*', 'admin/hub/view*', 'admin/hub-pricing*', 'admin/hub-payment*') ? 'show' : 'collapse' }} submenu">
                                    <ul class="nav flex-column">
                                        @if (hasPermission('hub_read') == true)
                                            <li class="nav-item ">
                                                <a class="nav-link {{ request()->is('admin/hubs*', 'admin/hub/view*', 'admin/hub/incharge*') ? 'active' : '' }}"
                                                    href="{{ route('hubs.index') }}">{{ __('menus.hubs') }}</a>
                                            </li>
                                        @endif
                                        @if (hasPermission('hub_payment_read') == true)
                                            <li class="nav-item">
                                                <a class="nav-link {{ request()->is('admin/request/hub/payment*', 'admin/hub-payment*') ? 'active' : '' }}"
                                                    href="{{ route('hub.hub-payment.index') }}">{{ __('menus.payments') }}</a>
                                            </li>
                                        @endif
                                        @if (hasPermission('hub_pricing_read') == true)
                                            <li class="nav-item">
                                                <a class="nav-link {{ request()->is('admin/hub-pricing*') ? 'active' : '' }}"
                                                    href="{{ route('hub-pricing.index') }}">
                                                    <i class="fas fa-route"></i> Hub Pricing
                                                </a>
                                            </li>
                                        @endif
                                    </ul>
                        ...
                        @if (hasPermission('merchant_read') == true || hasPermission('payment_read') == true)
                            <li class="nav-item">
                                <a class="nav-link {{ request()->is('admin/merchant/*', 'admin/payment*') ? 'active' : '' }}"
                                    href="#" data-bs-toggle="collapse" aria-expanded="false"
                                    data-bs-target="#merchant-manage" aria-controls="merchant-manage"><i
                        ...
                        @if (hasPermission('todo_read') == true)
                            <li class="nav-item ">
                                <a class="nav-link {{ request()->is('admin/todo/todo_list*') ? 'active' : '' }}"
                                    href="{{ route('todo.index') }}" aria-expanded="false" data-bs-target="#hubs"
                        ...
                        @if (hasPermission('support_read') == true)
                            <li class="nav-item ">
                                <a class="nav-link {{ request()->is('admin/support*') ? 'active' : '' }}"
                                    href="{{ route('support.index') }}" aria-expanded="false" data-bs-target="#hubs"
                        ...
                        @if (hasPermission('parcel_read') == true)
                            <li class="nav-item ">
                                <a class="nav-link {{ request()->is('admin/parcel*') ? 'active' : '' }}"
                                    href="{{ route('parcel.index') }}" aria-expanded="false" data-bs-target="#submenu-1"
                                    aria-controls="submenu-1"><i class="fa fa-dolly"></i>{{ __('menus.parcel') }}</a>
                            </li>
                        @endif

                        @if (hasPermission('collection_periods_read') == true || hasPermission('collection_sessions_read') == true || hasPermission('delivery_assignments_read') == true)
                            <li class="nav-item">
                                <a class="nav-link {{ request()->is('admin/collection-periods*', 'admin/collection-sessions*', 'admin/delivery-assignments*') ? 'active' : '' }}"
                                    href="#" data-bs-toggle="collapse" aria-expanded="false"
                                    data-bs-target="#collection-manage" aria-controls="collection-manage"><i
                                        class="fas fa-clock"></i>Collection Management</a>
                                <div id="collection-manage"
                                    class="{{ request()->is('admin/collection-periods*', 'admin/collection-sessions*', 'admin/delivery-assignments*') ? 'show' : 'collapse' }} submenu">
                                    <ul class="nav flex-column">
                                        @if (hasPermission('collection_periods_read') == true)
                                            <li class="nav-item ">
                                                <a class="nav-link {{ request()->is('admin/collection-periods*') ? 'active' : '' }}"
                                                    href="{{ route('collection-periods.index') }}">Collection Periods</a>
                                            </li>
                                        @endif
                                        @if (hasPermission('collection_sessions_read') == true)
                                            <li class="nav-item">
                                                <a class="nav-link {{ request()->is('admin/collection-sessions/current*') ? 'active' : '' }}"
                                                    href="{{ route('collection-sessions.current') }}">Current Sessions</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link {{ request()->is('admin/collection-sessions*') && !request()->is('admin/collection-sessions/current*') ? 'active' : '' }}"
                                                    href="{{ route('collection-sessions.index') }}">All Sessions</a>
                                            </li>
                                        @endif
                                        @if (hasPermission('delivery_assignments_read') == true)
                                            <li class="nav-item">
                                                <a class="nav-link {{ request()->is('admin/delivery-assignments*') ? 'active' : '' }}"
                                                    href="{{ route('delivery-assignments.index') }}">Delivery Assignments</a>
                                            </li>
                                        @endif
                                    </ul>
                                </div>
                        ...
                        @if (hasPermission('log_read') == true)
                            <li class="nav-item ">
                                <a class="nav-link {{ request()->is('admin/logs*') ? 'active' : '' }}"
                                    href="{{ route('logs.index') }}" aria-expanded="false" data-bs-target="#active_log"
                        ...
                        @if (hasPermission('fraud_read') == true)
                            <li class="nav-item ">
                                <a class="nav-link {{ request()->is('admin/fraud*') ? 'active' : '' }}"
                                    ...
                                    data-bs-target="#active_log" aria-controls="active_log"><i
                        ...
                        @if (hasPermission('pickup_request_regular') == true || hasPermission('pickup_request_express') == true)
                            <li class="nav-item">
                                <a class="nav-link {{ request()->is('admin/pickup-request*') ? 'active' : '' }}"
                                    href="#" data-bs-toggle="collapse" aria-expanded="false"
                                    data-bs-target="#pickup-request" aria-controls="hub-manage"><i
                        ...
                        @if (hasPermission('pickup_request_regular') == true || hasPermission('pickup_request_express') == true)
                            <li class="nav-item">
                                <a class="nav-link {{ request()->is('admin/bank*','admin/mobile-bank*') ? 'active' : '' }}"
                                    href="#" data-bs-toggle="collapse" aria-expanded="false"
                                    data-bs-target="#payment-method" aria-controls="hub-manage"><i
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ request()->is('admin/asset-category*', 'admin/assets*') ? 'active' : '' }} "
                                href="#" data-bs-toggle="collapse" aria-expanded="false" data-bs-target="#asset_management"
                                    ...
                                    @if (hasPermission('assets_read') == true)
                                        <li class="nav-item ">
                                            <a class="nav-link {{ request()->is('admin/assets/index', 'admin/assets/create', 'admin/assets/edit*', 'admin/assets/view*') ? 'active' : '' }}"
                                                href="{{ route('asset.index') }}" aria-expanded="false" data-bs-target="#hubs"
                                                aria-controls="hubs">
                                                {{ __('menus.assets') }}
                                            </a>
                                        </li>
                                    ...
                                    @if (hasPermission('maintenance_read') == true)
                                        <li class="nav-item ">
                                            <a class="nav-link {{ request()->is('admin/assets/maintenance', 'admin/assets/maintenance/create', 'admin/assets/maintenance/edit*') ? 'active' : '' }}"
                                                href="{{ route('maintenance.index') }}" aria-expanded="false" data-bs-target="#hubs"
                                                aria-controls="hubs">
                                    ...
                                    @if (hasPermission('accidents_read') == true)
                                        <li class="nav-item ">
                                            <a class="nav-link {{ request()->is('admin/assets/accident', 'admin/assets/accident/create', 'admin/assets/accident/edit*') ? 'active' : '' }}"
                                                href="{{ route('accident.index') }}" aria-expanded="false" data-bs-target="#hubs"
                                                aria-controls="hubs">
                                                {{ __('levels.accidents') }}
                                            </a>
                                        </li>
                        ...
                        @if (hasPermission('role_read') == true ||
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{ request()->is('admin/roles*', 'admin/users*', 'admin/designations*', 'admin/departments*') ? 'active' : '' }} "
                                    href="#" data-bs-toggle="collapse" aria-expanded="false"
                                    data-bs-target="#submenu-2" aria-controls="submenu-2"><i
                        ...
                        @if (hasPermission('salary_generate_read') == true || hasPermission('salary_read') == true)
                            <li class="nav-item">
                                <a class="nav-link {{ request()->is('admin/salary/salary-generate*', 'admin/salary*') ? 'active' : '' }}"
                                    href="#" data-bs-toggle="collapse" aria-expanded="false"
                                    data-bs-target="#salarygenerate" aria-controls="salarygenerate"><i
                                        ...
                                        @if (hasPermission('salary_generate_read') == true)
                                            <li class="nav-item ">
                                                <a class="nav-link {{ request()->is('admin/salary/salary-generate*', 'admin/reports/parcel-filter-reports') ? 'active' : '' }}"
                                                    ...
                                                    aria-expanded="false" data-bs-target="#submenu-1"
                        ...
                        @if (hasPermission('parcel_status_reports') == true || hasPermission('parcel_wise_profit') == true)
                            <li class="nav-item">
                                <a class="nav-link {{ request()->is('admin/reports/*') ? 'active' : '' }}"
                                    href="#" data-bs-toggle="collapse" aria-expanded="false"
                                    data-bs-target="#reports" aria-controls="reports"><i
                        ...
                        @if (hasPermission('social_link_read') == true || hasPermission('service_read') == true)
                            <li class="nav-item">
                                <a class="nav-link {{ request()->is('admin/front-web*') ? 'active' : '' }}"
                                    href="#" data-bs-toggle="collapse" aria-expanded="false"
                                    data-bs-target="#front-web" aria-controls="front-web"><i
                        ...
                        @if (hasPermission('delivery_category_read') == true ||
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{ request()->is('admin/database-backup*', 'admin/delivery-category*', 'admin/delivery-category*', 'admin/delivery-charge*', 'admin/packaging*', 'admin/delivery-type*', 'admin/liquid-fragile*', 'admin/sms-settings*', 'admin/sms-send-settings*', 'admin/general-settings*', 'admin/notification-settings*', 'admin/googlemap-settings*', 'admin/asset-category*', 'admin/social-login-setting*', 'admin/pay-out/setup*', 'admin/settings/pay-out/setup*', 'admin/settings/invoice-generate-menually*', 'admin/currency*', 'admin/mail-settings*') ? 'active' : '' }} "
                                    href="#" data-bs-toggle="collapse" aria-expanded="false"
                                    data-bs-target="#submenu-0" aria-controls="submenu-0"><i class="fa fa-cogs"></i>
                                    {{ __('menus.settings') }}</a>
