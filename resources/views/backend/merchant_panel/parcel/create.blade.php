                    ...
                    <div class="card-body-modern">
                        <form action="{{ route('merchant-panel.parcel.store') }}" method="POST" enctype="multipart/form-data" id="basicform">
                            ...
                            <div class="form-section">
                                ...
                                <div class="form-grid">
                                    <div class="form-field">
                                        ...
                                        <select id="shopID" class="modern-select" name="shop_id" data-url="{{ route('merchant-panel.parcel.merchant.shops') }}">
                                            <option value="">{{ __('menus.select') }} {{ __('parcel.shop') }}</option>
                                            @foreach ($shops as $shop)
                                                <option value="{{ $shop->id }}" {{ old('shop_id', $merchantShop->id) == $shop->id ? 'selected' : '' }}>
                                                    {{ $shop->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-field">
                                        ...
                                        <input id="pickup_phone" type="text" name="pickup_phone" class="modern-input" 
                                               placeholder="{{ __('parcel.pickup_phone') }}" 
                                    ...
                                    <div class="form-field">
                                        ...
                                        <input id="pickup_address" type="text" name="pickup_address" class="modern-input" 
                                               placeholder="{{ __('parcel.pickup_address') }}" 
                                               value="{{ old('pickup_address', $merchantShop->address) }}" required>
                                        <input type="hidden" id="pickup_lat" name="pickup_lat" required="" value="{{ $merchantShop->merchant_lat }}">
                                        <input type="hidden" id="pickup_long" name="pickup_long" required="" value="{{ $merchantShop->merchant_long }}">
                                ...
                                <div class="form-grid">
                                    <div class="form-field">
                                        ...
                                        <input id="customer_name" type="text" name="customer_name" class="modern-input" 
                                               placeholder="{{ __('parcel.customer_name') }}" 
                                    ...
                                    <div class="form-field">
                                        ...
                                        <input id="phone" type="text" name="customer_phone" class="modern-input" 
                                               placeholder="{{ __('parcel.customer_phone') }}" 
                            ...
                            <div class="form-actions">
                                <a href="{{ route('merchant-panel.parcel.index') }}" class="btn btn-secondary">
