                    ...
                    <div class="row  ">
                        <div class="col-12 ">
                            <div class="d-flex justify-content-end mt-2 mt-md-0">
                                <a href="{{ route('merchant.invoice.pdf',[$invoice->merchant_id,$invoice->invoice_id]) }}" class="btn btn-info btn-sm" target="_blank" data-toggle="tooltip" data-placement="top" title="Print Invoice"><i class="fa fa-file-pdf-o"></i> PDF</a>
                            </div>
                        </div>
                    </div>
