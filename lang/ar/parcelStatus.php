...
return array (
    ...
    ParcelStatus::RECEIVED_BY_PICKUP_MAN_CANCEL          => 'إلغاء الاستلام بواسطة مندوب الاستلام',
    ParcelStatus::RECEIVED_WAREHOUSE                     => 'المستودع المستلم',
    ParcelStatus::RECEIVED_WAREHOUSE_CANCEL              => 'تم استلام إلغاء المستودع',
    ParcelStatus::RECEIVED_BY_HUB_CANCEL                 => 'تم الاستلام من قبل الفرع — إلغاء',
    ParcelStatus::TRANSFER_TO_HUB                        => 'نقل إلى الفرع',
    ParcelStatus::TRANSFER_TO_HUB_CANCEL                 => 'إلغاء التحويل إلى الفرع',
    ParcelStatus::RECEIVED_BY_HUB                        => 'استلمها الفرع',
