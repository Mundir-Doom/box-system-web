...
class DeliveryManRepository implements DeliveryManInterface {
    ...
    public function all(){
        return DeliveryMan::with('uploadLicense','user.hub','hub')->orderByDesc('id')->where(function($query){
            if(request()->date) {
    ...
    public function filter($request){
        return DeliveryMan::with('uploadLicense','user.hub','hub')->where(function($query)use($request){
